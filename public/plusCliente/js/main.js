...
(function(_0xc3d6x1) {
    ...
    var _0xc3d6x2 = _0xc3d6x1('nav#menu')['mmenu']({
        ...
        navbars: [{
            position: 'bottom',
            content: ['<a href="https://www.soysoftware.com">\xA9 Soysoftware<sup>&reg;</sup></a>']
        }]
    }, {
        clone: true,
        classNames: {
    ...
    _0xc3d6x1('#sign-in')['magnificPopup']({
        ...
        midClick: true,
        removalDelay: 300,
        closeMarkup: '<button title="Cerrar" type="button" class="mfp-close">x</button>',
        mainClass: 'my-mfp-zoom-in'
    });
    _0xc3d6x1('#sign-in1')['magnificPopup']({
        type: 'inline',
        fixedContentPos: true,
        fixedBgPos: true,
        overflowY: 'auto',
