    ...
    <div class="row">
      <div class="col-md-6 box_grid wow" data-wow-offset="30">
        <div class="block-reveal">
         ...
         <img src="{{asset('/plusCliente/images/busDetalle.png')}}" alt="" width="200" class="img-fluid">
      ...
      <div id="sign-in-dialog" class="zoom-anim-dialog mfp-hide">
        <div class="small-dialog-header">
          ...
          <!-- /accordion payment -->        </div>
          <!--form -->
        </div>
        <div class="espacioModal">
          <center>
            <a href="#sign-in-dialog" id="sign-in" class="login" title="Ver más">
              <img class="tt-icon"  src="{{asset('/plusCliente/images/iconos/seo.svg')}}" class="img-fluid" width="80px" height="80px" ><h3>Ver Malla Curricular</h3></a> 
            </div>
          </div>
        </center>
        <div class="col-md-6 box_grid wow" data-wow-offset="30">
          <div class="block-reveal">
            ...
            <ul class="list-group" align="justify"  >
             <li class="list-group-item"> <img src="{{asset('/plusCliente/images/iconos/copy.svg')}}" class="img-fluid" width="50px" height="50px" > Copia a color notariada en una sola hoja de: cédula, papeleta de votación y licencia Tipo C mínimo dos años de vigencia </li>
             <li class="list-group-item"> <img src="{{asset('/plusCliente/images/iconos/certificado.svg')}}" class="img-fluid" width="50px" height="50px" > Certificado de haber aprobado el 1er. Año de bachillerato (4to. Curso)</li>
             <li class="list-group-item"> <img src="{{asset('/plusCliente/images/iconos/certificate.svg')}}" class="img-fluid" width="50px" height="50px" > Título de bachiller o acta de grado</li>
             <li class="list-group-item"> <img src="{{asset('/plusCliente/images/iconos/dni.svg')}}" class="img-fluid" width="50px" height="50px" > Carnet de tipo de sangre original (Cruz Roja)</li>
...
<div class="bg_color_1">
  <div class="container margin_50_35">
    ...
    <ul class="list-group" align="justify" style="font-size: 16px">
      <li class="list-group-item"> <img src="{{asset('/plusCliente/images/iconos/bus1.svg')}}" class="img-fluid" width="50px" height="50px" > -Para Servicio de Pasajeros (Intercnatonales, Interprovinciales, Intra-Provinciales, Intraregionales y por cuenta propia). 
      </li>
      ...
      <li class="list-group-item"> <img src="{{asset('/plusCliente/images/iconos/bus2.svg')}}" class="img-fluid" width="50px" height="50px" >
